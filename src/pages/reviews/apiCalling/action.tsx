...
const getDatas =
   ...
   async (dispatch) => {
      const response = await axiosClient.get(
         `/admin/reviews?status=${selectItemId}&search=${search}`
      );
      let totalItemsLength = response.data.data.length;
      ...
      dispatch(getItems(newPage, limit, response.data.data));
...
const dataDelete =
   ...
   async (dispatch: any) => {
      const response = await axiosClient.get(`/admin/review-delete/${id}`);
