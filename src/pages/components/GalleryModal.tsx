...
export default function GalleryModal({
  ...
  useEffect(() => {
    if (pathname === "/brand-create" || pathname === `/brand-edit/${id}`) {
      setGalleryCategoryName("Brand");
    } else if (
      pathname === "/categories" ||
      pathname === "/category-create" ||
      pathname === `/category-edit/${id}`
    ) {
      setGalleryCategoryName("Category");
    } else if (
      pathname === "/sub-categories" ||
      pathname === "/sub-category-create" ||
      pathname === `/sub-category-edit/${id}`
    ) {
      setGalleryCategoryName("Sub Category");
    } else if (
      pathname === "/products" ||
      ...
      pathname === `/offer-edit/${id}`
    ) {
      setGalleryCategoryName("Offer");
    } else if (
      pathname === "/banner-create" ||
      pathname === `/banner-edit/${id}`
    ) {
      setGalleryCategoryName("Banner");
    }
  }, [pathname, id]);
